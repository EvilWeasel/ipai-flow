...
<div class="mx-auto max-w-md px-4 py-10">
	<header class="mb-6 text-center">
		...
		<p class="text-sm text-muted-foreground mt-1">
			Join IPAI Flow with a username only. No email required.
		</p>
	</header>
	...
	>
		...
		<div class="space-y-1.5">
			...
			<Input id="password" name="password" type="password" required minlength={8} autocomplete="new-password" disabled={pending} />
